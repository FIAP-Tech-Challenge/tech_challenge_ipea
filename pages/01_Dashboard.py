...
st.markdown("<iframe title='Dashboard' width='1024' height='612' src='https://app.powerbi.com/view?r=eyJrIjoiMTMyMDNjYTItMDViYy00NTAwLTgwMjItMGExYzVmYjRlODdmIiwidCI6IjIzNjU0OGVlLTQ3YmYtNDEzNy1iZWFhLTA2OWMzOTdhMzA0ZCJ9' frameborder='0' allowFullScreen='true'></iframe>", unsafe_allow_html=True)
